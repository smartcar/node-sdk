 ...
 *
 * @method
 * @param {number} chargeLimit - a number between 0 and 1
 * @returns {ChargeLimit}
 * @throws {SmartcarError} - an instance of SmartcarError.
 *   See the [errors section](https://github.com/smartcar/node-sdk/tree/master/doc#errors)
 *   for all possible errors.
 ...
 * }
 */
Vehicle.prototype.setChargeLimit = async function(chargeLimit) {

  const body = {
    limit: String(chargeLimit),
  };

  // TEMP!!!
  // eslint-disable-next-line no-console
  console.log('Passing -->', body);
