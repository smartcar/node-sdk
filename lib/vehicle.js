 ...
 * @method
 * @memberof Vehicle
 * @returns {DiagnosticSystemStatusResponse} - The response containing diagnostic system statuses.
 ...
 * @method
 * @memberof Vehicle
 * @returns {DiagnosticTroubleCodesResponse} - The response containing active
 ...
 * @property {Array} availableCapacities - A list of the rated nominal capacities available for a vehicle
 * @property {Object} capacity - The rated nominal capacity for the vehicle's battery in kWh
 * @property {String} url - A URL that will launch the flow for a vehicle owner to specify the correct battery capacity for a vehicle
 * @property {Meta} meta
 *
 * @example
 * {
