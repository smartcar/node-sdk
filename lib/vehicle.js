...
Vehicle.prototype.info = function() {
  return util.wrap(this.request.get('/'))
    .then(function(response) {
      return _.pick(response, ['id', 'make', 'model', 'year']);
    });
};
...
Vehicle.prototype.location = function() {
  ...
  return util.wrap(req)
    .then(function(response) {
      return {
        data: _.pick(response.body, ['latitude', 'longitude']),
        age: response.headers['sc-data-age'],
      };
    });
};
...
Vehicle.prototype.odometer = function() {
  ...
  return util.wrap(req)
    .then(function(response) {
      return {
        data: _.pick(response.body, ['distance']),
        age: response.headers['sc-data-age'],
