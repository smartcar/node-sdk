...
/**
* POST Vehicle.setChargeLimit
*
* @param {Float} limit the charge limit, between 0 and 1
*
* @return {Promise} A success or failure response
*/
...
Vehicle.prototype.activateChildSafetyLocks = function(childSafetyLocksArr) {
  ...
  var data = {childSafetyLocks: childSafetyLocksArr};
  data.action = 'LOCK';
  return this.request({
    uri: 'doors/child_safety_locks',
    body: data,
