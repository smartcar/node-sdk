 ...
 *   kms or miles). To set unit, @see {@link setUnitSystem}.
 * @property {Date} age - The timestamp of when the data was recorded.
 ...
 *  liters or gallons (US)). To set unit, @see [setUnitSystem](@link Vehicle#setUnitSystem).
 * @property {Date} age - The timestamp of when the data was recorded.
 ...
 * @property {Object} data - The returned vehicle data.
 * @property {Number} data.range - The estimated remaining distance the car can
 *  travel (in kms or miles).To set unit, @see {@link setUnitSystem}.
