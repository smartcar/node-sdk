 ...
 * @param {String} [options.mode] - Launch Smartcar Connect in live mode,
 * [test mode](https://smartcar.com/docs/guides/testing/), or [simulated mode](https://smartcar.com/docs/guides/testing/)
 */
function AuthClient(options = {}) {
  ...
  this.mode = options.mode ? options.mode.toLowerCase() : 'live';
