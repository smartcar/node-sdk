 ...
 * must exactly match one of the registered URLs. This parameter is optional
 * and should normally be set within the Smartcar Dashboard.
 ...
 * requires. The valid permission names are found in the
 * [API Reference](https://smartcar.com/docs/guides/scope/). This is an optional parameter
 * that should normally be set up within the Smartcar Dashboard.
 * @param {Object} [options]
 ...
 */
AuthClient.prototype.getAuthUrl = function(scopeOrOptions, options = {}) {
  let scope;
  if (Array.isArray(scopeOrOptions)) {
    scope = scopeOrOptions;
    options = options || {};
  } else if (typeof scopeOrOptions === 'object' && scopeOrOptions !== null) {
  ...
  return `${util.getConfig('SMARTCAR_API_ORIGIN') || config.connect
