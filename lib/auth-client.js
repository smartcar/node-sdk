 ...
 * @param {String[]} [options.flags] - An optional list of flags that enables early
 * access features. The naming of the flags is colon separated for any sub-options
 * the flag may have (ex: country:DE).
