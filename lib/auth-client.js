 ...
 * @param {Boolean} [options.testMode=false] - Launch the Smartcar Connect in
 * test mode.
 * [API Reference](https://smartcar.com/docs/guides/testing/).
 ...
 * @return {String} Smartcar Connect to direct user to.
 * @example
