 ...
 * permissions.
 * @param {Object|string} [options.vehicleInfo] - `vehicleInfo` can be either a
 * VIN string or an object with properties `vin`, `year`, `make`, and
 ...
 * with Smartcar
 */
AuthClient.prototype.isCompatible = function(vin) {
  const qs = { vin };
